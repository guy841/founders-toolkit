/* UK Companies House condensed SIC 2007 list (731 codes).
   The official "nature of business: SIC codes" list used when filing at
   Companies House. Sourced from the MIT-licensed sic-codes npm package,
   which mirrors the Companies House condensed list. Do not hand-edit —
   regenerate from the source list if Companies House updates it. */
window.SIC_CODES = [
